...
export const showResultBloodTypeTest = async (bloodTypeId: number, fetchResultBloodTypeApi: IFetchResultBloodTypeApi): Promise<string> => {
    // const fetchResultBloodTypeApi: FetchResultBloodTypeApi = new FetchResultBloodTypeApi;
    const fetcher : IFetchResultBloodTypeApi = fetchResultBloodTypeApi;
    const fetchData: BloodTypeTest = await fetcher.getResultBloodTypeTest(bloodTypeId);
...
export class MockEnemyChoiseRock implements IEnemy{
    public getRandomHand(): string {
        return "rock";
    }
}

export class MockEnemyChoiseScissors implements IEnemy{
    public getRandomHand(): string {
        return "scissors";
    }
}

export class MockEnemyChoisePaper implements IEnemy{
    public getRandomHand(): string {
        return "paper";
    }
}